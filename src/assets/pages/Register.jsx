  ...
  return (
    <form className="max-w-sm mx-auto">
      ...
      <div className="flex items-start mb-5">
        ...
        <label htmlFor="terms" className="ms-2 text-sm font-medium text-gray-900 dark:text-blue-950">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label>
      </div>
